...
public class RemarkCommand extends Command {
    ...
    public static final String MESSAGE_USAGE = COMMAND_WORD
            ...
            + "r/ Likes to swim.";
    public static final String MESSAGE_REMARK_SUCCESS = "Remark person: %1$s with: ";
    ...
    public CommandResult execute(Model model) throws CommandException {
        ...
        return new CommandResult(String.format(MESSAGE_REMARK_SUCCESS, Messages.format(editedPerson)));
    }
